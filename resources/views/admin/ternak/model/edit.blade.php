...
@section('title', 'Edit Data Ternak')
        ...
        <div class="container-fluid">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Ternak: {{ $ternak->tag_number }}</h3>
                </div>
                <form action="{{ route('ternak.update', $ternak->tag_number) }}" method="POST">
                    @csrf
                    @method('PUT') {{-- Gunakan metode PUT untuk pembaruan --}}
                    <div class="card-body">
                        <div class="form-group">
                            <label for="tag_number">TAG NUMBER</label>
                            {{-- Tag number biasanya tidak diubah karena merupakan primary key --}}
                            <input type="text" class="form-control" id="tag_number" name="tag_number" value="{{ $ternak->tag_number }}" readonly>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control @error('species_id') is-invalid @enderror" id="species_id" name="species_id">
                                ...
                                @foreach($species as $sp)
                                    <option value="{{ $sp->id }}" {{ old('species_id', $ternak->species_id) == $sp->id ? 'selected' : '' }}>{{ $sp->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kategori_id') is-invalid @enderror" id="kategori_id" name="kategori_id">
                                ...
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}" {{ old('kategori_id', $ternak->kategori_id) == $kategori->id ? 'selected' : '' }}>{{ $kategori->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('sub_kategori_id') is-invalid @enderror" id="sub_kategori_id" name="sub_kategori_id">
                                ...
                                @foreach($subKategoris as $sub)
                                    <option value="{{ $sub->id }}" {{ old('sub_kategori_id', $ternak->sub_kategori_id) == $sub->id ? 'selected' : '' }}>{{ $sub->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('tipe_domba_id') is-invalid @enderror" id="tipe_domba_id" name="tipe_domba_id">
                                ...
                                @foreach($tipeDombas as $tipeDomba)
                                    <option value="{{ $tipeDomba->id }}" {{ old('tipe_domba_id', $ternak->tipe_domba_id) == $tipeDomba->id ? 'selected' : '' }}>{{ $tipeDomba->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('jenis_domba_id') is-invalid @enderror" id="jenis_domba_id" name="jenis_domba_id">
                                ...
                                @foreach($jenisDombas as $jenisDomba)
                                    <option value="{{ $jenisDomba->id }}" {{ old('jenis_domba_id', $ternak->jenis_domba_id) == $jenisDomba->id ? 'selected' : '' }}>{{ $jenisDomba->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                <option value="Jantan" {{ old('gender', $ternak->gender) == 'Jantan' ? 'selected' : '' }}>Jantan</option>
                                <option value="Betina" {{ old('gender', $ternak->gender) == 'Betina' ? 'selected' : '' }}>Betina</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kandang_id') is-invalid @enderror" id="kandang_id" name="kandang_id">
                                ...
                                @foreach($kandangs as $kandang)
                                    <option value="{{ $kandang->kandang_id }}" {{ old('kandang_id', $ternak->kandang_id) == $kandang->kandang_id ? 'selected' : '' }}>{{ $kandang->kandang_id }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $ternak->date_of_birth) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_of_entry') is-invalid @enderror" id="date_of_entry" name="date_of_entry" value="{{ old('date_of_entry', $ternak->date_of_entry) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('usia_masuk_dalam_bulan') is-invalid @enderror" id="usia_masuk_dalam_bulan" name="usia_masuk_dalam_bulan" value="{{ old('usia_masuk_dalam_bulan', $ternak->usia_masuk_dalam_bulan) }}" placeholder="Masukkan Usia Masuk dalam Bulan" min="0">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kondisi_id') is-invalid @enderror" id="kondisi_id" name="kondisi_id">
                                ...
                                @foreach($kondisis as $kondisi)
                                    <option value="{{ $kondisi->id }}" {{ old('kondisi_id', $ternak->kondisi_id) == $kondisi->id ? 'selected' : '' }}>{{ $kondisi->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('entry_weight') is-invalid @enderror" id="entry_weight" name="entry_weight" value="{{ old('entry_weight', $ternak->entry_weight) }}" placeholder="Masukkan Berat Masuk">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('current_weight') is-invalid @enderror" id="current_weight" name="current_weight" value="{{ old('current_weight', $ternak->current_weight) }}" placeholder="Masukkan Berat Saat Ini">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('last_weight_date') is-invalid @enderror" id="last_weight_date" name="last_weight_date" value="{{ old('last_weight_date', $ternak->last_weight_date ? \Carbon\Carbon::parse($ternak->last_weight_date)->format('Y-m-d') : '') }}">
                            @error('last_weight_date')<span class="invalid-feedback" role="alert">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
                            <label for="upweight">Upweight (kg)</label> 
                            <input type="number" step="0.01" class="form-control" id="upweight" name="upweight" value="{{ $ternak->upweight ?? '-' }}" readonly>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status_id') is-invalid @enderror" id="status_id" name="status_id">
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status->id }}" {{ old('status_id', $ternak->status_id) == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('dam_tag_number') is-invalid @enderror" id="dam_tag_number" name="dam_tag_number">
                                ...
                                @foreach($parents as $parent)
                                    <option value="{{ $parent->tag_number }}" {{ old('dam_tag_number', $ternak->dam_tag_number) == $parent->tag_number ? 'selected' : '' }}>{{ $parent->tag_number }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('sire_tag_number') is-invalid @enderror" id="sire_tag_number" name="sire_tag_number">
                                ...
                                @foreach($parents as $parent)
                                    <option value="{{ $parent->tag_number }}" {{ old('sire_tag_number', $ternak->sire_tag_number) == $parent->tag_number ? 'selected' : '' }}>{{ $parent->tag_number }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3" placeholder="Tambahkan catatan">{{ old('notes', $ternak->notes) }}</textarea>
                            @error('notes')<span class="invalid-feedback" role="alert">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
                            <label for="photo_path">Path Foto (Opsional)</label>
                            <input type="text" class="form-control @error('photo_path') is-invalid @enderror" id="photo_path" name="photo_path" value="{{ old('photo_path', $ternak->photo_path) }}" placeholder="Masukkan Path Foto atau URL">
