<?php $__env->startSection('title', 'Data Investor'); ?>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <a href="<?php echo e(route('investor.create')); ?>" class="btn btn-primary"><i class="fas fa-plus mr-1"></i>Investor</a>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('investor.index')); ?>" method="GET" class="mb-3">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 ml-auto">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" name="search" placeholder="Cari Investor..." value="<?php echo e($search); ?>">
                        ...
                        <table class="table table-hover table-bordered text-center">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $investors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($loop->iteration + ($investors->currentPage() - 1) * $investors->perPage()); ?></td>
                                        <td><?php echo e($investor->name); ?></td>
                                        <td><?php echo e($investor->phone_number ?? '-'); ?></td>
                                        <td><?php echo e($investor->address ?? '-'); ?></td>
                                        <td>
                                            <div class="btn-group btn-group-sm-1" role="group">
                                                <a href="<?php echo e(route('investor.show', $investor->id)); ?>" class="btn btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                                                <a href="<?php echo e(route('investor.edit', $investor->id)); ?>" class="btn btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
                                                <form action="<?php echo e(route('investor.destroy', $investor->id)); ?>" method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                ...
                <div class="card-footer clearfix">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="text-muted">Menampilkan <?php echo e($investors->firstItem()); ?> hingga <?php echo e($investors->lastItem()); ?> dari <?php echo e($investors->total()); ?> data</span>
                        
                        <?php echo e($investors->links('pagination::bootstrap-4')); ?>
    ...
    <div class="modal fade" id="importCsvModal" tabindex="-1" role="dialog" aria-labelledby="importCsvModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('investor.import')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sphin\Documents\GitHub\glowing-waddle\resources\views/admin/investor/index.blade.php ENDPATH**/ ?>